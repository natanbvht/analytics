...
/* @CoreHome/_menu.twig */
class __TwigTemplate_87fb06de8148d40c80a56498dfdb74ba extends Template
{
    private $source;
    private $macros = [];
    ...
    public function macro_menu($__menu__ = null, $__anchorlink__ = null, $__cssClass__ = null, $__currentModule__ = null, $__currentAction__ = null, $__collapsible__ = null, ...$__varargs__)
    {
        ...
        <ul class=\"navbar ";
            ...
            foreach ($context['_seq'] as $context["level1"] => $context["level2"]) {
                ...
                if ((isset($context["hasSubmenuItem"]) || array_key_exists("hasSubmenuItem", $context) ? $context["hasSubmenuItem"] : (function () { throw new RuntimeError('Variable "hasSubmenuItem" does not exist.', 14, $this->source); })())) {
                    ...
                    // line 17
                    echo \Piwik\piwik_escape_filter($this->env, ((twig_get_attribute($this->env, $this->source, $context["level2"], "_icon", [], "any", true, true, false, 17)) ? (_twig_default_filter(twig_get_attribute($this->env, $this->source, $context["level2"], "_icon", [], "any", false, false, false, 17), "icon-chevron-down")) : ("icon-chevron-down")), "html", null, true);
                    echo "\"></span>";
                    ...
                    foreach ($context['_seq'] as $context["name"] => $context["urlParameters"]) {
                        ...
                        if ((twig_slice($this->env, $context["name"], 0, 1) != "_")) {
                            ...
                            if (twig_get_attribute($this->env, $this->source, $context["urlParameters"], "_help", [], "any", false, false, false, 41)) {
                                // line 42
                                echo "                                            <div vue-entry=\"CoreHome.ShowHelpLink\" name=\"";
        ...
        <div vue-entry=\"CoreHome.MobileLeftMenu\" menu=\"";
            // line 55
            echo \Piwik\piwik_escape_filter($this->env, json_encode((isset($context["menu"]) || array_key_exists("menu", $context) ? $context["menu"] : (function () { throw new RuntimeError('Variable "menu" does not exist.', 55, $this->source); })())), "html", null, true);
            echo "\"></div>
    </div>
";
    ...
    {
        return array (  241 => 55,  238 => 54,  232 => 53,  226 => 50,  219 => 49,  215 => 47,  209 => 46,  205 => 44,  197 => 42,  195 => 41,  189 => 39,  183 => 38,  180 => 37,  174 => 36,  171 => 35,  165 => 33,  163 => 32,  159 => 31,  154 => 28,  149 => 27,  146 => 26,  143 => 25,  140 => 24,  136 => 23,  130 => 22,  124 => 19,  117 => 17,  110 => 16,  107 => 15,  105 => 14,  102 => 13,  96 => 12,  93 => 11,  90 => 10,  87 => 9,  82 => 8,  79 => 7,  77 => 6,  74 => 5,  70 => 4,  62 => 3,  57 => 2,  39 => 1,);
    }
...
{% endmacro %}
", "@CoreHome/_menu.twig", "/Users/natanandlacey/source/analytics/src/plugins/CoreHome/templates/_menu.twig");
    }
}
