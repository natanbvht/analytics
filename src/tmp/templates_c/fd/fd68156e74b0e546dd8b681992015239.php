...
class __TwigTemplate_f592cea30a3dd95bae31d485fd88188d extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        <ul>
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["challenge"]) {
                ...
                if ((twig_get_attribute($this->env, $this->source, $context["challenge"], "isCompleted", [], "any", false, false, false, 26) || twig_get_attribute($this->env, $this->source, $context["challenge"], "isSkipped", [], "any", false, false, false, 26))) {
                    ...
                    // line 29
                    echo "                        <a href=\"javascript:void 0;\" class=\"skip-challenge\" onclick=\"tourEngagement.skipChallenge('";
        ...
        <p class=\"tourSuperUserNote\">";
            // line 50
            echo $this->env->getFilter('translate')->getCallable()("Tour_OnlyVisibleToSuperUser", $this->env->getFunction('externallink')->getCallable()("https://matomo.org/faq/general/faq_35/"), "</a>");
            echo "</p>
        <script>
...
", "@Tour/engagement.twig", "/Users/natanandlacey/source/analytics/src/plugins/Tour/templates/engagement.twig");
    }
}
