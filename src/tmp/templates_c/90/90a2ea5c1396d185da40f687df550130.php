...
class __TwigTemplate_a3b9053be4597d7790992c3dc6cae10b extends Template
{
    private $source;
    private $macros = [];
    ...
    <p>
        ";
        // line 14
        echo $this->env->getFilter('translate')->getCallable()("Installation_GetInvolved", $this->env->getFunction('externallink')->getCallable()("https://matomo.org/get-involved/"), "</a>");
        echo "
        ";
        // line 15
        echo $this->env->getFilter('translate')->getCallable()("General_HelpTranslatePiwik", $this->env->getFunction('externallink')->getCallable()("https://matomo.org/translations/"), "</a>");
        echo "
    </p>
    <p>";
        // line 17
    ...
    ";
        ...
        <p>
            ";
            // line 23
            echo $this->env->getFilter('translate')->getCallable()("Installation_ProfessionalServicesfessionalServicesAdText", $this->env->getFunction('externallink')->getCallable()("https://plugins.matomo.org/premium"), "</a>", $this->env->getFunction('externallink')->getCallable()("https://matomo.org/support-plans/"));
            echo "
        </p>
        <p>
            ";
            // line 26
            echo $this->env->getFilter('translate')->getCallable()("Installation_ProfessionalServicesfessionalDiscoverHow", $this->env->getFunction('externallink')->getCallable()("https://matomo.org/matomo-cloud/"), "</a>");
            echo "
        </p>
    ";
        }
    ...
    <p>";
        // line 31
        echo $this->env->getFilter('translate')->getCallable()("Installation_PerformanceSettingsDesc1", $this->env->getFunction('externallink')->getCallable()("https://matomo.org/docs/setup-auto-archiving/"), "</a>");
        echo "</p>
    <p>";
        // line 32
        echo $this->env->getFilter('translate')->getCallable()("Installation_PerformanceSettingsDesc2", $this->env->getFunction('externallink')->getCallable()("https://matomo.org/docs/setup-auto-archiving/"), "</a>");
        echo "</p>
...
{% endblock %}
", "@Installation/finished.twig", "/Users/natanandlacey/source/analytics/src/plugins/Installation/templates/finished.twig");
    }
}
