...
class __TwigTemplate_c1ea79601200340ab1ef7868154b967c extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        if ((isset($context["trackNoScript"]) || array_key_exists("trackNoScript", $context) ? $context["trackNoScript"] : (function () { throw new RuntimeError('Variable "trackNoScript" does not exist.', 18, $this->source); })())) {
            echo "<noscript><p><img referrerpolicy=\"no-referrer-when-downgrade\" src=\"{\$protocol}{\$piwikUrl}/{\$matomoPhpFilename}?idsite={\$idSite}&amp;rec=1\" style=\"border:0;\" alt=\"\" /></p></noscript>
";
        }
        // line 20
...
{% endif %}
<!-- End Matomo Code -->
", "@Morpheus/javascriptCode.twig", "/Users/natanandlacey/source/analytics/src/plugins/Morpheus/templates/javascriptCode.twig");
    }
}
