...
class __TwigTemplate_c87e5033feac2c4d124dc3aae4484684 extends Template
{
    private $source;
    private $macros = [];
    ...
    {
        return new Source("<br />{{ 'GeoIp2_GeoIPVariablesConfigurationHere'|translate('<a href=\"' ~ configUrl|e('html_attr') ~ '\">', '</a>')|raw }}", "@GeoIp2/serverModule.twig", "/Users/natanandlacey/source/analytics/src/plugins/GeoIp2/templates/serverModule.twig");
    }
}
