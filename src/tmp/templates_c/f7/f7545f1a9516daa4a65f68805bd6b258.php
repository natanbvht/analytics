...
class __TwigTemplate_d7217ea70c01913b8ce49f2045b32905 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div>
        ...
        if ( !twig_test_empty(twig_get_attribute($this->env, $this->source, (isset($context["action"]) || array_key_exists("action", $context) ? $context["action"] : (function () { throw new RuntimeError('Variable "action" does not exist.', 15, $this->source); })()), "url", [], "any", false, false, false, 15))) {
            ...
            // line 20
            echo "            ";
            if ((((is_string($__internal_compile_0 = twig_lower_filter($this->env, twig_trim_filter(twig_get_attribute($this->env, $this->source, (isset($context["action"]) || array_key_exists("action", $context) ? $context["action"] : (function () { throw new RuntimeError('Variable "action" does not exist.', 20, $this->source); })()), "url", [], "any", false, false, false, 20)))) && is_string($__internal_compile_1 = "javascript:") && str_starts_with($__internal_compile_0, $__internal_compile_1)) || (is_string($__internal_compile_2 = twig_lower_filter($this->env, twig_trim_filter(twig_get_attribute($this->env, $this->source,             // line 21
...
", "@Live/_actionCommon.twig", "/Users/natanandlacey/source/analytics/src/plugins/Live/templates/_actionCommon.twig");
    }
}
