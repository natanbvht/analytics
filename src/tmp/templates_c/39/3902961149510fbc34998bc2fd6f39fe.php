...
class __TwigTemplate_5b0c4cf35deef02b4cdd51185f481c12 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div>
        <div class=\"visitor-profile-visit-title\" data-idvisit=\"";
            // line 4
            echo \Piwik\piwik_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["visitInfo"], "getColumn", ["idVisit"], "method", false, false, false, 4), "html", null, true);
            echo "\" title=\"";
            ...
            // line 7
            echo \Piwik\piwik_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["visitInfo"], "getColumn", ["serverDatePrettyFirstAction"], "method", false, false, false, 7), "html", null, true);
            echo " ";
            echo \Piwik\piwik_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["visitInfo"], "getColumn", ["serverTimePrettyFirstAction"], "method", false, false, false, 7), "html", null, true);
            echo "\">
                ";
            // line 8
            echo \Piwik\piwik_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["visitInfo"], "getColumn", ["serverDatePrettyFirstAction"], "method", false, false, false, 8), "html", null, true);
            echo " ";
            echo \Piwik\piwik_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["visitInfo"], "getColumn", ["serverTimePrettyFirstAction"], "method", false, false, false, 8), "html", null, true);
            echo "
            </span>
        </div>
        ...
        <div class=\"visitor-profile-visit-details\">
            ...
            <a href=\"#\" class=\"visitor-profile-show-actions\">
                ";
            // line 17
            $context["actionCount"] = twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, $context["visitInfo"], "getColumn", ["actionDetails"], "method", false, false, false, 17));
            // line 18
            echo "                ";
            ...
            // line 21
            echo "                ";
            if ((twig_get_attribute($this->env, $this->source, $context["visitInfo"], "getColumn", ["visitDuration"], "method", false, false, false, 21) != 0)) {
                // line 22
                echo "                    ";
                echo \Piwik\piwik_escape_filter($this->env, $this->env->getFilter('translate')->getCallable()("Live_ActionsAndDuration", (isset($context["actionCount"]) || array_key_exists("actionCount", $context) ? $context["actionCount"] : (function () { throw new RuntimeError('Variable "actionCount" does not exist.', 22, $this->source); })()), twig_get_attribute($this->env, $this->source, $context["visitInfo"], "getColumn", ["visitDurationPretty"], "method", false, false, false, 22)), "html", null, true);
                echo "
                ";
            } else {
                // line 24
        ...
        <ol class=\"visitorLog visitor-profile-actions actionList\">
            ";
            // line 29
            $this->loadTemplate("@Live/_actionsList.twig", "@Live/getVisitList.twig", 29)->display(twig_array_merge($context, ["actionDetails" => twig_get_attribute($this->env, $this->source, $context["visitInfo"], "getColumn", ["actionDetails"], "method", false, false, false, 29), "actionGroups" => twig_get_attribute($this->env, $this->source,             // line 30
...
{% endfor %}", "@Live/getVisitList.twig", "/Users/natanandlacey/source/analytics/src/plugins/Live/templates/getVisitList.twig");
    }
}
