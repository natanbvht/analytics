...
class __TwigTemplate_43209ac8a7c0b3b22df57ccf212a78bf extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"piwik-donate-message\">
        ...
        ";
            ...
            <p>";
            // line 8
            echo $this->env->getFilter('translate')->getCallable()("CoreHome_DonateCall3", "<strong>", "</strong>", ($this->env->getFunction('externallink')->getCallable()("https://matomo.org/recommends/premium-plugins/") . "<strong>"), "</strong></a>");
            echo "</p>
        ";
        }
        // line 10
...
", "@CoreHome/_donate.twig", "/Users/natanandlacey/source/analytics/src/plugins/CoreHome/templates/_donate.twig");
    }
}
