...
class __TwigTemplate_86f385892ffa9164e20d368692796117 extends Template
{
    private $source;
    private $macros = [];
        ...
        <tbody>";
            ...
            ";
                ...
                foreach ($context['_seq'] as $context["rowId"] => $context["row"]) {
                    ...
                    // line 25
                    $context["rowSubtableId"] = ((twig_get_attribute($this->env, $this->source, $context["row"], "getMetadata", ["idsubdatatable_in_db"], "method", true, true, false, 25)) ? (_twig_default_filter(twig_get_attribute($this->env, $this->source, $context["row"], "getMetadata", ["idsubdatatable_in_db"], "method", false, false, false, 25), twig_get_attribute($this->env, $this->source, $context["row"], "getIdSubDataTable", [], "method", false, false, false, 25))) : (twig_get_attribute($this->env, $this->source, $context["row"], "getIdSubDataTable", [], "method", false, false, false, 25)));
                    // line 26
                    $context["isSummaryRow"] = (($context["rowId"] == twig_constant("Piwik\\DataTable::ID_SUMMARY_ROW")) || twig_get_attribute($this->env, $this->source, $context["row"], "getMetadata", ["is_summary"], "method", false, false, false, 26));
                    // line 27
                    ...
                    // line 28
                    $context["dimensions"] = ((twig_get_attribute($this->env, $this->source, ($context["dataTable"] ?? null), "getMetadata", ["dimensions"], "method", true, true, false, 28)) ? (_twig_default_filter(twig_get_attribute($this->env, $this->source, ($context["dataTable"] ?? null), "getMetadata", ["dimensions"], "method", false, false, false, 28), [])) : ([]));
                    // line 29
                    echo "
                ";
                    // line 31
...
($context["properties"] ?? null), "replace_row_with_subtable", [], "any", true, true, false, 34)) ? (_twig_default_filter(twig_get_attribute($this->env, $this->source, ($context["properties"] ?? null), "replace_row_with_subtable", [], "any", false, false, false, 34), false)) : (false)));
                    ...
                    if ((isset($context["showRow"]) || array_key_exists("showRow", $context) ? $context["showRow"] : (function () { throw new RuntimeError('Variable "showRow" does not exist.', 36, $this->source); })())) {
                        ...
                        // line 38
                        echo "                    ";
                        if ( !$this->env->getTest('false')->getCallable()(twig_get_attribute($this->env, $this->source, $context["row"], "getMetadata", ["segment"], "method", false, false, false, 38))) {
                            echo " data-segment-filter=\"";
                            echo \Piwik\piwik_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["row"], "getMetadata", ["segment"], "method", false, false, false, 38), "html_attr");
                            echo "\"";
                        }
                        // line 39
                        echo "                    ";
                        if ( !$this->env->getTest('false')->getCallable()(twig_get_attribute($this->env, $this->source, $context["row"], "getMetadata", ["url"], "method", false, false, false, 39))) {
                            echo " data-url-label=\"";
                            echo $this->env->getFilter('rawSafeDecoded')->getCallable()(twig_get_attribute($this->env, $this->source, $context["row"], "getMetadata", ["url"], "method", false, false, false, 39));
                            echo "\"";
                        }
                        // line 40
                    ...
                    class=\"";
                        // line 41
                        echo \Piwik\piwik_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["row"], "getMetadata", ["css_class"], "method", false, false, false, 41), "html", null, true);
                        echo " ";
                    ...
                    ";
                        ...
                        if ((((array_key_exists("rowIdentifier", $context)) ? (_twig_default_filter((isset($context["rowIdentifier"]) || array_key_exists("rowIdentifier", $context) ? $context["rowIdentifier"] : (function () { throw new RuntimeError('Variable "rowIdentifier" does not exist.', 43, $this->source); })()))) : ("")) != "label")) {
                            echo "data-label=\"";
                            echo \Piwik\piwik_escape_filter($this->env, ((twig_get_attribute($this->env, $this->source, $context["row"], "getColumn", [(isset($context["rowIdentifier"]) || array_key_exists("rowIdentifier", $context) ? $context["rowIdentifier"] : (function () { throw new RuntimeError('Variable "rowIdentifier" does not exist.', 43, $this->source); })())], "method", false, false, false, 43)) ? (twig_get_attribute($this->env, $this->source, $context["row"], "getColumn", [(isset($context["rowIdentifier"]) || array_key_exists("rowIdentifier", $context) ? $context["rowIdentifier"] : (function () { throw new RuntimeError('Variable "rowIdentifier" does not exist.', 43, $this->source); })())], "method", false, false, false, 43)) : (twig_get_attribute($this->env, $this->source, $context["row"], "getMetadata", [(isset($context["rowIdentifier"]) || array_key_exists("rowIdentifier", $context) ? $context["rowIdentifier"] : (function () { throw new RuntimeError('Variable "rowIdentifier" does not exist.', 43, $this->source); })())], "method", false, false, false, 43))), "html", null, true);
                            echo "\" data-label-pretty=\"";
                            echo \Piwik\piwik_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["row"], "getColumn", ["label"], "method", false, false, false, 43), "html", null, true);
                            echo "\"";
                        }
                        // line 44
                        echo "                >
...
(isset($context["dimensions"]) || array_key_exists("dimensions", $context) ? $context["dimensions"] : (function () { throw new RuntimeError('Variable "dimensions" does not exist.', 64, $this->source); })())]));
                ...
                if ((twig_get_attribute($this->env, $this->source, (isset($context["dataTable"]) || array_key_exists("dataTable", $context) ? $context["dataTable"] : (function () { throw new RuntimeError('Variable "dataTable" does not exist.', 76, $this->source); })()), "getTotalsRow", [], "any", false, false, false, 76) && twig_get_attribute($this->env, $this->source, (isset($context["properties"]) || array_key_exists("properties", $context) ? $context["properties"] : (function () { throw new RuntimeError('Variable "properties" does not exist.', 76, $this->source); })()), "show_totals_row", [], "any", false, false, false, 76))) {
                    ...
                    // line 79
                    echo "                <tr class=\"";
                    echo \Piwik\piwik_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["row"]) || array_key_exists("row", $context) ? $context["row"] : (function () { throw new RuntimeError('Variable "row" does not exist.', 79, $this->source); })()), "getMetadata", ["css_class"], "method", false, false, false, 79), "html", null, true);
                    echo " totalsRow\"
...
{% else %}
    ...
    {%- endif -%}
{% endif %}", "@CoreVisualizations/_dataTableViz_htmlTable.twig", "/Users/natanandlacey/source/analytics/src/plugins/CoreVisualizations/templates/_dataTableViz_htmlTable.twig");
    }
}
